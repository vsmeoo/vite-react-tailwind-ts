    ...
    <Container>
        <nav className="w-full flex justify-between gap-6 relative">
            ...
            lg:bg-transparent border-x border-x-box-border lg:border-x-0 lg:h-auto h-0 overflow-hidden">
                ...
                <ul className="border-t border-box-border lg:border-t-0 px-6 lg:px-0 pt-6 lg:pt-0 flex flex-col lg:flex-row
                gap-y-4 gap-x-7 text-lg text-heading-2 w-full lg:justify-center lg:items-center">
